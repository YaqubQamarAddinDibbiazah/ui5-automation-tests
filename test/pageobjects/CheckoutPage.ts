...
class CheckoutPage extends BasePage{
    ...
    async selectPaymentMethodAndProceed(paymentMethod : "Credit Card" | "Bank Transfer" | "Cash on Delivery"){
    ...
    async insertCardDetailsAndProceed(name : string, cardNumber : string, securityCode : string, expDate : string){
    ...
    async fillDetailsAndProceed(street : string , city : string , zipCode : string , country : string, note : string = ""){
